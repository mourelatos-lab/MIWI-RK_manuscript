...
sdir="RIBOSeq_sample" # Main sample directory
...
STAR --runThreadN $threads --genomeDir $refdir/STAR-2.7.2b-annot/ \
    ...
    --outFilterType BySJout --outFilterMultimapNmax 20 --outFilterMultimapScoreRange 0 --outFilterScoreMinOverLread 0.66 \
    --outFilterMatchNmin 15 --outFilterMatchNminOverLread 0.8 --outFilterMismatchNmax 4 --outFilterMismatchNoverLmax 1 \
    --outFilterMismatchNoverReadLmax 1 --outFilterIntronMotifs RemoveNoncanonicalUnannotated --seedSearchStartLmax 10 \
    --alignIntronMin 20 --alignIntronMax 1000000 --alignSJoverhangMin 5 --alignSJDBoverhangMin 3 --alignEndsType Extend5pOfRead1 \
